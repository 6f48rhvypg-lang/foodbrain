...
- `foodbrain_assistant.cli` provides `foodbrain --sample`, `foodbrain --grocy-stock-json`, `foodbrain --diagnose-grocy-stock-json`, `foodbrain --recipes-json`, `foodbrain --grocy-recipes-json`, `foodbrain --diagnose-grocy-recipes-json`, `foodbrain --grocy-recipes`, and `foodbrain` for live Grocy runs.
